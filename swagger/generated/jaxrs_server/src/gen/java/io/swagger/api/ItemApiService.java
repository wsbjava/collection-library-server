...
public abstract class ItemApiService {
    public abstract Response rentRequest(ItemRentalRequest body,SecurityContext securityContext) throws NotFoundException;
}
