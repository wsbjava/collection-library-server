...
public class UserSuggestionList   {
  ...
  @JsonProperty("data")
  private List<Suggestion> data = new ArrayList<Suggestion>();

  public UserSuggestionList total(Integer total) {
    this.total = total;
    return this;
  }
  ...
  public UserSuggestionList data(List<Suggestion> data) {
    this.data = data;
    return this;
  }

  public UserSuggestionList addDataItem(Suggestion dataItem) {
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UserSuggestionList userSuggestionList = (UserSuggestionList) o;
    return Objects.equals(this.total, userSuggestionList.total) &&
        Objects.equals(this.data, userSuggestionList.data);
  }
  ...
  public String toString() {
    ...
    sb.append("class UserSuggestionList {\n");
