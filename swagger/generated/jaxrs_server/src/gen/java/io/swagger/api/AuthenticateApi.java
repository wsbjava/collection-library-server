...
public class AuthenticateApi  {
   ...
   public AuthenticateApi(@Context ServletConfig servletContext) {
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Authenticate user", notes = "Authentication of existing user", response = AuthenticationResponse.class, tags={  })
    @io.swagger.annotations.ApiResponses(value = { 
        @io.swagger.annotations.ApiResponse(code = 200, message = "OK", response = AuthenticationResponse.class),
